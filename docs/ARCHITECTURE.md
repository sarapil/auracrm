# AuraCRM — Architecture Guide

## System Overview
AuraCRM is built on the Frappe Framework as a modular customer relationship management solution.
...
## هيكل النظام (عربي)
AuraCRM مبني على إطار عمل فريب كحل Customer Relationship Management متكامل.
