...
# 🔗 AuraCRM + ERPNext Ecosystem: Better Together

> **How AuraCRM integrates with ERPNext and other Arkan Lab apps to create a complete business solution**

---

## The Power of Integration

AuraCRM doesn't work in isolation. It's designed to be part of a **connected ecosystem**:

- **ERPNext CRM** — seamless data flow and shared workflows
- **Arrowz Communication** — seamless data flow and shared workflows
- **CAPS Permissions** — seamless data flow and shared workflows
- **Frappe Visual Dashboards** — seamless data flow and shared workflows
...
4. **Project started** with full tracking (AuraCRM manages the details)
...
# Install all
bench --site your-site install-app caps frappe_visual arkan_help auracrm arrowz
```
