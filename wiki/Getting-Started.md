...
bench get-app auracrm https://github.com/sarapil/auracrm.git
...
2. **Find the App** — ابحث عن التطبيق: Look for AuraCRM icon on the desk
3. **Configure Settings** — اضبط الإعدادات: Go to AuraCRM Settings
...
- 🐛 [Report Bug](https://github.com/sarapil/auracrm/issues/new?template=bug_report.yml)
- ✨ [Request Feature](https://github.com/sarapil/auracrm/issues/new?template=feature_request.yml)
