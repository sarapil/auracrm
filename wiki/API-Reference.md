...
All AuraCRM APIs follow the Arkan Lab API standards.

## Base URL — الرابط الأساسي

```
POST /api/method/auracrm.api.v1.<module>.<function>
```
...
```bash
curl -X POST 'https://site.example.com/api/method/auracrm.api.v1.records.get_list' \
