...
```bash
bench --site dev.localhost get-untranslated ar --app auracrm
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `auracrm/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app auracrm | wc -l
```
...
2. Edit/create the CSV file in `auracrm/translations/`
