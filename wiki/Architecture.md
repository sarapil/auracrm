...
AuraCRM follows the Arkan Lab architecture standards built on Frappe v16.
...
class MyDocType(Document):
    def validate(self):
        from auracrm.services.my_service import MyService
...
```python
from auracrm.api.response import success, error, paginated
