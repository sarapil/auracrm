...
"""
AuraCRM — Demo Data
Load/clear demo data for AuraCRM showcases.
...
def load_demo_data():
    """Load demonstration data for AuraCRM.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for AuraCRM"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for AuraCRM"))
